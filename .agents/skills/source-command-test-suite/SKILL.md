---
name: "source-command-test-suite"
description: "Migrated source command `test-suite`"
---

# source-command-test-suite

Use this skill when the user asks to run the migrated source command `test-suite`.
