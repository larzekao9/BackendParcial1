---
name: "source-command-fraud-analysis"
description: "Migrated source command `fraud-analysis`"
---

# source-command-fraud-analysis

Use this skill when the user asks to run the migrated source command `fraud-analysis`.
