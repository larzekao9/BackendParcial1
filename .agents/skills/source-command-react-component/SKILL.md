---
name: "source-command-react-component"
description: "Migrated source command `react-component`"
---

# source-command-react-component

Use this skill when the user asks to run the migrated source command `react-component`.
