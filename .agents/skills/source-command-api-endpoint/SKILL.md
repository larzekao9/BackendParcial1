---
name: "source-command-api-endpoint"
description: "Migrated source command `api-endpoint`"
---

# source-command-api-endpoint

Use this skill when the user asks to run the migrated source command `api-endpoint`.
